  ...
  return (
    <div className={`min-h-screen flex flex-col relative ${enviando ? 'pointer-events-none' : ''}`}>
      ...
      <div className={enviando ? 'opacity-50 pointer-events-none' : ''}>
        <Cabecalho isHomeFree={true} isDefinirTrilha={true} formularioDesabilitado={false} onLogout={handleLogout} />
      ...
      <Rodape
        linksRapidos={[
          { label: 'Home', path: '/home-free', onClick: () => { handleNavigate('/home-free'); window.scrollTo({ top: 0, behavior: 'smooth' }) } },
          { label: 'Formulário para Definição de Trilha', path: '/usuario/definir-trilha', onClick: () => { handleNavigate('/usuario/definir-trilha'); window.scrollTo({ top: 0, behavior: 'smooth' }) } }
        ]}
...
export default DefinirTrilhaFree
