          ...
          if (diagnosticosDoUsuario.length > 0) {
            ...
            if (diagnosticosComTrilha.length > 0) {
              ...
              const trilhaEncontrada = trilhasListadas.find(t => {
                ...
                return nomeTrilhaLower.includes('tecnologia') || 
                       nomeTrilhaLower.includes('tech') ||
                       nomeTrilhaLower.includes('tecn')
              })
...
export default TrilhaTecnologia
