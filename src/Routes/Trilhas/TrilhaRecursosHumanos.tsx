          ...
          if (diagnosticosDoUsuario.length > 0) {
            ...
            if (diagnosticosComTrilha.length > 0) {
              ...
              const trilhaEncontrada = trilhasListadas.find(t => {
                ...
                return nomeTrilhaLower.includes('recursos humanos') || 
                       nomeTrilhaLower.includes('recursos human') ||
                       nomeTrilhaLower.includes('rh')
              })
...
export default TrilhaRecursosHumanos
