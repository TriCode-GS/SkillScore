...
import fotoLucas from '../assets/img/Integrantes/Lucas Silva Gastão Pinheiro.jpg'
import fotoGeovanne from '../assets/img/Integrantes/Geovanne Coneglian Passos.png'
import fotoGuilherme from '../assets/img/Integrantes/Guilherme Soares de Almeida.jpg'
import iconGithub from '../assets/img/Redes Sociais/github.png'
import iconLinkedin from '../assets/img/Redes Sociais/linkedin.png'
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {integrantes.map((integrante, index) => (
                <div 
                  key={index}
                  className="bg-white border-2 border-indigo-200 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow"
                >
                  <div className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-indigo-100 rounded-full flex items-center justify-center mb-4 overflow-hidden">
                      {integrante.foto ? (
                        <img 
                          src={integrante.foto} 
                          alt={integrante.nome}
                    ...
                    <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 px-2">
                      {integrante.nome}
                    </h2>
