      ...
      <main className="flex-grow bg-white">
        <section className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 sm:mb-8 text-center px-4">
              Sobre o SkillScore
            </h1>
            <div className="prose prose-lg max-w-none px-4">
              ...
              <p className="text-gray-700 mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed">
                A startup <strong className="text-indigo-600">TriCode</strong> desenvolveu o <strong className="text-indigo-600">SkillScore</strong>, 
